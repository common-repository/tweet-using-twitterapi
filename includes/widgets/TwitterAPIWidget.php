...
class TwitterAPIWidget extends WP_Widget{
	...
	public function form( $instance ) {
		...
		<div class="tf-feed-settings">
			<p>
				<label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'tweet-using-twitterapi' ); ?></label> 
				<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>">
			</p>
			<p>
				<label for="<?php echo $this->get_field_id( 'type' ); ?>"><?php _e( 'Type:', 'tweet-using-twitterapi' ); ?></label> 
				<select class="widefat" name="<?php echo $this->get_field_name( 'type' ); ?>"> 
					<option <?php echo(esc_attr( $type ) == 'mentions_timeline') ? 'selected': null; ?> value="mentions_timeline"><?php _e( 'Mentions Timeline', 'tweet-using-twitterapi' ); ?></option>					
					<option <?php echo(esc_attr( $type ) == 'user_timeline') ? 'selected': null; ?> value="user_timeline"><?php _e( 'User Timeline', 'tweet-using-twitterapi' ); ?></option>
					<option <?php echo(esc_attr( $type ) == 'home_timeline') ? 'selected': null; ?> value="home_timeline"><?php _e( 'Home Timeline', 'tweet-using-twitterapi' ); ?></option>
					<option <?php echo(esc_attr( $type ) == 'retweets_own_by_others') ? 'selected': null; ?> value="retweets_own_by_others"><?php _e( 'Own Retweets', 'tweet-using-twitterapi' ); ?></option>
				</select>
			</p>
			<p>
				<label for="<?php echo $this->get_field_id( 'tf_show_profile_thumnails' ); ?>"><?php _e( 'Enable Profile thumbnail:', 'tweet-using-twitterapi' ); ?></label> 
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'tf_post_images' ); ?>"><?php _e( 'Enable Post Images:', 'tweet-using-twitterapi' ); ?></label> 
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'tf_widget_height' ); ?>"><?php _e( 'Height:', 'tweet-using-twitterapi' ); ?></label> 
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'tf_no_of_tweets' ); ?>"><?php _e( 'Number of Tweets:', 'tweet-using-twitterapi' ); ?></label> 
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'tf_follow_button' ); ?>"><?php _e( 'Follow Button:', 'tweet-using-twitterapi' ); ?></label> 
		...
		<div class="tf-feed-scroller">
			<h3><?php _e('Scroller Styles', 'tweet-using-twitterapi'); ?></h3>
			<p>
				<label for="<?php echo $this->get_field_id( 'tf_scroll_color' ); ?>"><?php _e( 'Scroller Color', 'tweet-using-twitterapi' ); ?></label> 
			</p>
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'tf_scroll_width' ); ?>"><?php _e( 'Scroller Width', 'tweet-using-twitterapi' ); ?></label> 
			...
			<p>
				<label for="<?php echo $this->get_field_id( 'tf_widget_theme' ); ?>"><?php _e( 'Choose Theme:', 'tweet-using-twitterapi' ); ?></label> 
				<select class="widefat" name="<?php echo $this->get_field_name( 'tf_widget_theme' ); ?>"> 
					<option <?php echo(esc_attr( $tf_widget_theme ) == 'tf_default_widget_theme') ? 'selected': null; ?> value="tf_default_widget_theme"><?php _e( 'Default Theme', 'tweet-using-twitterapi' ); ?></option>		
					<option <?php echo(esc_attr( $tf_widget_theme ) == 'tf_block_widget_theme') ? 'selected': null; ?> value="tf_block_widget_theme"><?php _e( 'Styled Box Theme', 'tweet-using-twitterapi' ); ?></option>
					<option <?php echo(esc_attr( $tf_widget_theme ) == 'tf_black_widget_theme') ? 'selected': null; ?> value="tf_black_widget_theme"><?php _e( 'Black Theme', 'tweet-using-twitterapi' ); ?></option>
