 ...
 * Plugin URI:        https://deepenbajracharya.com.np/
 ...
 * Text Domain:       tweet-using-twitterapi
 * Domain Path:       /languages
 */


if(!defined('ABSPATH')) {
	die('No Kiddie Script Please');
	exit;
}
...
define( 'TF_REQUIRED_PHP_VERSION', '5.6' );
define( 'TF_PLUGIN_VERSION', '1.3.3' );
